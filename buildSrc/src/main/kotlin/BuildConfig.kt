object BuildConfig {
    ...
    val minecraftVersionRange: String = ">=1.20.1 <=1.20.4"
    ...
    val meadowVersion: String = "Zg8XweNS" //1.3.24
    val moonlightVersion: String = "fabric_1.20-2.13.82"
    val supplementariesVersion: String = "KFHfXxsW" //1.20-3.1.26
}